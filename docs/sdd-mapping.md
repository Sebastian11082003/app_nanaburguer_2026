...
| 12-ux-ui | parcial | Login único + chrome de tenant (logotipo/nombre/slug) en personal, POS, admin y hubs. Nav por rol. Piso: ocupada a $0 muestra “Sin cuenta”; salir de ticket vacío libera solo mesa. Llevar/domicilio se retoman; un CREATED vacío se descarta a mano. Pedidos activos es cola DELIVERY. Caja cobra domicilio en camino/entregado. Ventas y cocina nombran mesa/Llevar/Domicilio. Caja/admin en `restaurant-navigation.ts`. |
