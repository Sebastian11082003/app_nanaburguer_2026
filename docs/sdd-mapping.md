...
| 12-ux-ui | parcial | Login único. Cancelar ítem en mesa, Ventas, Llevar, domicilio y detalle admin de mesa (permiso `ORDERS_CANCEL_ITEM`, caja/admin por defecto). Liberar mesa vacía también después de cocina. Recoge visible en KDS/comanda/listas. Cobro con Servicio 5%. Piso omite tickets sin líneas vivas. Recibo distingue recargo de propina. Correo de personal editable. Caja puede transferir mesa. Recibos en chrome de caja. Cajero no cobra sin turno abierto. |
