...
| 11-quality | parcial | Jest en backend (roles, órdenes, caja). Reportes/caja tienen UI sobre el API existente. No hay `testing-strategy.md`. Huecos de HU vs código en [mvp-production-readiness.md](mvp-production-readiness.md). |
