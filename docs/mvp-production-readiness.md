...
**Actualizado en `dev` (v0.4.58):** cierre de turno, poll, cancelar ítem, Liberar mesa post-cocina, KDS limpio, transferir desde caja, hora de recoger editable, recibo al cobrar, aviso si caja cerrada, Recibos en chrome de caja, backlog en `.ai-engineering/BACKLOG.md`. Lo que sigue abajo describía `dev` @ v0.4.9.
