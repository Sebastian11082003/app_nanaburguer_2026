 ...
 * info changed. Shared by admin Facturas and POS cobro.
 */
export function InvoiceReceiptView({
  ...
  async function handleAccept() {
    try {
      ...
      setError(getErrorMessage(err, "No se pudo emitir la factura"));
    } finally {
      setBusy(false);
    }
  }
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      {showAccept && invoice.status === "PENDING" && (
